...
routes.put('/:id', [authJWT.verifyToken],  ProductController.update);// -> Actualizar un producto
routes.delete('/:id', [authJWT.verifyToken, authJWT.isModerator],  ProductController.destroy);// -> Eliminar un producto
